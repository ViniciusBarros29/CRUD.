...
<?php
    ...
    while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
        echo "Número do Candidato: {$linha['id']} <br> Nome do Candidato: {$linha['nome']} <br> Equipe: {$linha['equipe']}";
        echo " - <a href=javascript:excluirRegistro('acao.php?acao=excluir&id={$linha['nome']}')>Excluir</a><br>";
        echo "<hr>";
    }
?>       
<h3>PS: Caso tenha se Candidatado por engano clique em "excluir" abaixo das suas informações</h3>
<hr>
